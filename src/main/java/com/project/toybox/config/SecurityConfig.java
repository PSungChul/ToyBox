...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    SignService signService; // UserDetailsService를 implements한 서비스 (시스템 --> DB)
                                 // 로그인에서 DB에 있는 사용자 계정을 조회할때 사용할 서비스
                                 // Remember me에서 DB에 있는 사용자 계정을 조회할때 사용할 서비스

    @Autowired
    SignOAuthService signOAuthService; // OAuth2UserService를 implements한 서비스
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    @Override
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .exceptionHandling()
                        .accessDeniedPage("/"); // 권한이 없는 대상이 접속을 시도했을 때 이동할 경로v
        ...
        http
                ...
                .usernameParameter("id") // 아이디 파라미터명 설정 - 로그인 form에 아이디 name명과 동일하게 작성한다.
        ...
        http
                ...
                .userService(signOAuthService); // 소셜 로그인 성공 후속 조치를 진행할 UserService 인터페이스의 구현체를 등록한다.
        ...
        http
                ...
                .userDetailsService(signService) // Remember me에서 DB에 있는 사용자 계정을 조회할때 사용할 서비스
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth
                .userDetailsService(signService) // 로그인 할때 DB에 있는 사용자 계정을 조회할때 사용할 서비스
